...
<body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    <div class="absolute w-full bg-red-500 dark:hidden min-h-75">
                        ...
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            ...
                            <form action="" method="POST">
                                <div class="mb-6 mt-5">
                                    ...
                                    <input type="namasiswa" id="namasiswa" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" value="{{$students->name}}" required>
                                </div>
                                <div class="mb-6 -mt-2">
                                    <label for="forum" class="block mb-2 text-sm font-bold text-gray-700">EMAIL</label>
                                    <input type="forum" id="forum" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" value="{{$students->email}}" required>
                                </div>
                                <a href="/datasiswa" class="inline-flex items-center mt-2 px-5 py-2 mb-6 text-sm font-semibold text-center text-white bg-yellow-500 rounded-lg hover:bg-yellow-300">
                                    Cancel
                                </a>
