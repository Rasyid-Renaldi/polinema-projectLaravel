                                    ...
                                    <form>
                                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                            ...
                                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                                <label for="editor" class="sr-only">Edit post</label>
                                        ...
                                        <div class="-mt-4 mb-4">
                                            ...
                                            <div>
                                                <button type="submit" class="inline-flex items-center mt-10 px-5 py-2 text-sm font-semibold text-center text-white bg-red-500 rounded-lg hover:bg-red-300">
                                                    Edit post
                                                </button>
                                    </form>
                                    <!-- end form Pertanyaan -->
