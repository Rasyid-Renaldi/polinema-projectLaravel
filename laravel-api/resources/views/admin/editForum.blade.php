                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            ...
                            <form>
                                <div class="mb-6 mt-5">
                                    <label for="namasiswa" class="block mb-2 text-sm font-bold text-gray-700">NAMA TOPIK DISKUSI</label>
                                ...
                                <div class="mb-6 -mt-2">
                                    <label for="forum" class="block mb-2 text-sm font-bold text-gray-700">TOTAL POSTINGAN</label>
                                ...
                                <div class="mb-6 -mt-2">
                                    <label for="forum" class="block mb-2 text-sm font-bold text-gray-700">TOTAL SISWA YANG BERDISKUSI</label>
                                    <input type="forum" id="forum" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 placeholder=" nama siswa" required>
                                </div>
                                <div class="mb-6 -mt-2">
                                    <label for="tanggalmasuk" class="block mb-2 text-sm font-bold text-gray-700">TANGGAL DIBUAT</label>
