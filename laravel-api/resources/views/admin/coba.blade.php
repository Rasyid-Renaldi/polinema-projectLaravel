                        ...
                        <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                                ...
                                <li class="text-sm leading-normal ml-1">
                                    <a class="text-black opacity-20" href="/dataLaporan"> / Dashboard</a>
                                </li>
                            </ol>
                            <h6 class="mb-0 font-bold text-black opacity-20 capitalize">Forum</h6>
                            <div class="mb-6">
                                <h4 class="mb-0 pt-6 font-bold text-black opacity-20 capitalize">Forum Diskusi MejaKita</h4>
                                <div class="pt-2">
                                    <button type="submit" class="py-1 px-3 text-sm font-medium text-center text-white rounded-lg bg-red-500 sm:w-fit hover:bg-red-50 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Yuk Tanya</button>
                                </div>

                                <div class="block max-w-sm p-6 mt-4 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                    <img src="../assets/img/bibrieziq.jpg" class="inline-flex justify-center mr-4 text-sm text-white transition-all duration-200 ease-in-out h-12 w-12 rounded-xl" />
                                    <div class="flex flex-wrap text-center lg:text-left lg:block">
                                        <h5 class="mb-2 mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Muhammad Nur Kamdi</h5>
                                        <p class="font-normal text-gray-700 dark:text-gray-400">hal</p>
                                    </div>
                                </div>
